...
| **M3-07**   | **Implement role bindings and authorization policy.** Admin/owner/publisher/viewer/denied capabilities and transactional/idempotent group binding replacement have no escalation or partial update; safe audits.                                               | AUTHZ-01 policy-engine matrix plus binding rollback/group-change cases.                       | M3-02, M3-03, M3-06        | B-OKTA for real group mapping                                            |
