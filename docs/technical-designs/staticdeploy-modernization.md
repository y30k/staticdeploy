...
| DNS/TLS/exposure | Portal/wildcard hosts, certificates, registrable-site/browser matrix, trusted proxy chain, query-log redaction, cache bypass, fresh never-used content origins and permanent retirement after any worker allowance, viewer policy, route-cutover access | External preview/publishing and M7                |
